...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # Changing field 'SeeMembers.birthdate'
        db.alter_column('see_members_seemembers', 'birthdate', self.gf('django.db.models.fields.PositiveIntegerField')(max_length=12))

        # Changing field 'SeeMembers.phone_cell'
        db.alter_column('see_members_seemembers', 'phone_cell', self.gf('django.db.models.fields.PositiveIntegerField')(max_length=11))

        # Changing field 'SeeMembers.phone_home'
        db.alter_column('see_members_seemembers', 'phone_home', self.gf('django.db.models.fields.PositiveIntegerField')(max_length=20))

        # Changing field 'SeeMembers.zip_code'
        db.alter_column('see_members_seemembers', 'zip_code', self.gf('django.db.models.fields.PositiveIntegerField')(max_length=6))
    ...
    models = {
        'see_members.seemembers': {
            ...
            'birthdate': ('django.db.models.fields.PositiveIntegerField', [], {'blank': 'True'}),
            ...
            'phone_cell': ('django.db.models.fields.PositiveIntegerField', [], {'blank': 'True'}),
            'phone_home': ('django.db.models.fields.PositiveIntegerField', [], {'blank': 'True'}),
            'surname': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            'town': ('django.db.models.fields.CharField', [], {'max_length': '100', 'blank': 'True'}),
            'zip_code': ('django.db.models.fields.PositiveIntegerField', [], {'blank': 'True'})
        }
    }
