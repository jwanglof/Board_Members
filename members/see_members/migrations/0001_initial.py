...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'SeeMembers'
        db.create_table('see_members_seemembers', (
            ...
            ('birthdate', self.gf('django.db.models.fields.PositiveIntegerField')(max_length=12, blank=True)),
            ...
            ('zip_code', self.gf('django.db.models.fields.PositiveIntegerField')(max_length=6, blank=True)),
            ('town', self.gf('django.db.models.fields.CharField')(max_length=100, blank=True)),
            ('phone_home', self.gf('django.db.models.fields.PositiveIntegerField')(max_length=20, blank=True)),
            ('phone_cell', self.gf('django.db.models.fields.PositiveIntegerField')(max_length=11, blank=True)),
        ...
        db.send_create_signal('see_members', ['SeeMembers'])


    def backwards(self, orm):
        # Deleting model 'SeeMembers'
        db.delete_table('see_members_seemembers')
