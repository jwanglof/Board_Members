...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('see_members_seemembers', 'birthdate', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'SeeMembers.phone_cell'
        db.alter_column('see_members_seemembers', 'phone_cell', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'SeeMembers.phone_home'
        db.alter_column('see_members_seemembers', 'phone_home', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'SeeMembers.zip_code'
        db.alter_column('see_members_seemembers', 'zip_code', self.gf('django.db.models.fields.IntegerField')(null=True))

    def backwards(self, orm):

        # Changing field 'SeeMembers.birthdate'
        db.alter_column('see_members_seemembers', 'birthdate', self.gf('django.db.models.fields.IntegerField')(default=0))

        # Changing field 'SeeMembers.phone_cell'
        db.alter_column('see_members_seemembers', 'phone_cell', self.gf('django.db.models.fields.IntegerField')(default=0))

        # Changing field 'SeeMembers.phone_home'
        db.alter_column('see_members_seemembers', 'phone_home', self.gf('django.db.models.fields.IntegerField')(default=0))

        # Changing field 'SeeMembers.zip_code'
        db.alter_column('see_members_seemembers', 'zip_code', self.gf('django.db.models.fields.IntegerField')(default=0))
